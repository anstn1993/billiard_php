...
<form enctype='multipart/form-data' action="add_editted_article.php" method="post">
    ...
    <table>
        <tr>
            ...
            <td>
                <input type="text" name="title" required="required" placeholder="글의 제목을 입력하세요!" size="50"
        ...
        <tr>
            ...
            <td>
                <textarea name="article" required="required" wrap="soft" placeholder="당구에 대해 하고 싶은 말을 마음껏 하세요!"
                          rows="20" cols="80"><?php echo $row['article']; ?></textarea>
            </td>
        </tr>
        <tr>
            <td>
    ...
    <div class="upload_cancel">
        ...
        <button class="upload_cancel_child" type="button" name="cancel" onclick="location.href='freeboard.php'">취소
        </button>
    </div>
