...
<form enctype='multipart/form-data' action="add_editted_event.php" method="post">
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <textarea name="article" required="required" wrap="soft" placeholder="이벤트에 대한 설명을 적어주세요." rows="20"
                          cols="80"><?php echo $row['article']; ?></textarea>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input id="begin_date" type="date" name="begin" required="required" value=<?php echo $row['begin']; ?>>~<input
                        id="end_date" type="date" name="end" required="required" value=<?php echo $row['end']; ?>>
            </td>
        </tr>
