...
$sql = "
  SELECT*FROM freeboard_comment WHERE id={$_GET['id']}
";
...
<h2>댓글 수정</h2>
<br>
<form action="add_editted_freeboard_comment.php" method="post">
    <input type="hidden" name="id" value=<?= $_GET['id'] ?>>
    <textarea name="comment" rows="8" cols="80"
              placeholder="이곳에 수정할 댓글을 입력하세요."><?php echo $row['comment'] ?></textarea>
