    ...
    <div class="mypage_child" id="mypage_article">
        ...
        <form action="edit_myinfo_complete.php" method="post" onsubmit="return edit_myinfo()">
            <table id="edit_myinfo_table">
                ...
                <tr>
                    <td>비밀번호</td>
                    <td><input id="password_input" type="password" name="password" size=30
                ...
                <tr>
                    <td>비밀번호 확인</td>
                    <td><input id="password_check_input" type="password" name="password_check" size=30
                               value=<?php echo $_SESSION['password']; ?>></td>
                </tr>
                ...
                <tr>
                    <td>닉네임</td>
                    <td><input id="nickname_input" type="text" name="nickname" size=30
                               value='<?php echo $_SESSION['nickname']; ?>'></td>
                </tr>
                ...
                <tr>
                    <td>이름</td>
                    <td><input id="name_input" type="text" name="name" size=30 value=<?php echo $_SESSION['name']; ?>>
                    </td>
                </tr>
                ...
                <tr>
                    <td>휴대폰번호</td>
                    <td><input id="tel1_input" type="tel" name="tel1" maxlength="3" size="6" value=<?php echo $tel1; ?>>-<input
                                id="tel2_input" type="tel" name="tel2" maxlength="4" size="6"
                                value=<?php echo $tel2; ?>>-
                        <input id="tel3_input" type="tel" name="tel3" maxlength="4" size="6" value=<?php echo $tel3; ?>>
                    </td>
                </tr>
                <tr id="tel_check">
