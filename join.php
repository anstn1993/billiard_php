...
<body>
  ...
  <form action="join_complete.php" method="post" onsubmit="return join()">
    <table>
      ...
      <tr>
        <td>휴대폰번호</td>
        <td><input id="tel1_input" type="tel" name="tel1" maxlength="3" size="6">-<input id="tel2_input" type="tel" name="tel2" maxlength="4" size="6">-<input id="tel3_input" type="tel" name="tel3" maxlength="4" size="6"></td>
      </tr>
      <tr id="tel_check">
