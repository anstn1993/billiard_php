...
<div class="mypage">
    ...
    <div class="mypage_child" id="mypage_article">
        ...
        <div id="delivery_category">
            <a href='order_admin.php' style="background-color:#F2B08F">배송 전</a>
                         ...
                         <td style='border-bottom: 1px solid black;'>
                          ...
                          <td style='border-bottom: 1px solid black;'>
                            <select class=\"delivery_category\" name=\"delivery_status[]\">
                              <option value=\"no\" selected='selected'>배송 전</option>
        ...
        <div id="page">
            ...
            if (!empty($min_number) && !empty($max_number)) {
                ...
                echo ($page != 1) ? "<a href=\"order_admin.php?page=1\">[처음으로]</a>" : "[처음으로]";

                echo ($current_block != 1) ? "<a href=\"order_admin.php?page={$start_page_}\">[이전]</a>" : "[이전]";
                ...
                for ($i = $start_page; $i <= $end_page; $i++) {
                    if ($i == $page) {
                        echo "
                <a href=\"order_admin.php?page={$i}\" style=\"color:red; border:1px solid gray;\">{$i}</a>
              ";
                    } else {
                        echo "
                <a href=\"order_admin.php?page={$i}\">{$i}</a>
              ";
                    }
                ...
                echo ($current_block != $total_block) ? "<a href=\"order_admin.php?page={$end_page_}\">[다음]</a>" : "[다음]";
                //현재 페이지가 마지막 페이지가 아닌 경우에만 마지막 페이지로 가는 버튼이 나오게 한다.
                echo ($page != $total_page) ? "<a href=\"order_admin.php?page={$total_page}\">[마지막으로]</a>" : "[마지막으로]";
            }
            ?>
        </div>
    </div>
