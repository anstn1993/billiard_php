...
<html lang="en" dir="ltr">
  ...
  <div class="main">
    ...
    <h1 class="upload_article_style">게시글 작성</h1>
    <br>
    <form enctype='multipart/form-data' action="add_uploaded_article.php" method="post">
      <table>
        <tr>
          <td>
            제목
        ...
        <tr>
          ...
          <td>
            <textarea name="article" required="required" wrap="soft" placeholder="당구에 대해 하고 싶은 말을 마음껏 하세요!" rows="20" cols="80"></textarea>
          </td>
        </tr>
        <tr>
          <td>
      ...
      <div class="upload_cancel">
        <input class="upload_cancel_child" type="submit" value="게시물 등록">
