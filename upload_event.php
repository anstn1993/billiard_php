    ...
    <form enctype='multipart/form-data' action="add_uploaded_event.php" method="post">
      <table>
        ...
        <tr>
          ...
          <td>
            <textarea name="article" required="required" wrap="soft" placeholder="이벤트에 대한 설명을 적어주세요." rows="20" cols="80"></textarea>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <input id="begin_date" type="date" name="begin" required="required">~<input id="end_date" type="date" name="end" required="required">
          </td>
        </tr>
        <tr>
          <td>
